...
# Panel (c) shows several grooved boundaries meeting at triple junctions,
# not a single boundary (S. Baird, PR #12, 2026-07-22).
PANELS = [
    ("ppt/media/image8.tif", "(a) Edge view, 350x"),
    ("ppt/media/image7.tif", "(b) Edge view, 800x"),
    ("ppt/media/image9.tif", "(c) Grooved boundaries, 12,000x"),
]
