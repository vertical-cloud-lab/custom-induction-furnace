...
control path. When the modernization stack is moved to a different
...
% Resolved (S. Baird, PR #12, 2026-07-22): the sample stack rests on a
% retaining ring of a KF40 flange (now stated in Sec. II). Crucibles are repaired
...
only a
monotonic analog power-control input, the design transfers across generators and
