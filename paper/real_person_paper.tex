...
Crucibles are repaired
with graphite cement rather than discarded. The crucible is used primarily
...
feeds the automated vent valve. A mass flow controller between them is helpful
...
boundaries traverse the full sheet thickness. This is a step toward columnar
grain structures~\cite{zhang2007dynamicsandmechanism}.
...
thermal grooving alone. Grain sizes were measured directly in the calibrated
microscope image~\cite{bramfitt2001metallographersguidepractice}.
...
columnar grain-growth studies as a natural next application.
