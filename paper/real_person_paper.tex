...
end seats in a teflon tube at the KF40 fitting below.
% Support-path description per S. Baird (PR #12, 2026-07-22): the alumina
% support is a tube (not a rod), with lateral vent holes, its lower end in a
% teflon tube at the KF40 fitting. A parallel same-day wording pass states
...
its outer perimeter to aid evacuation, and a teflon tube couples its lower
end to the KF40 fitting. The coil, vacuum, pyrometer, and control paths are
