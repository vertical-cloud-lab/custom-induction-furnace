...
The coil is modular, and this geometry was chosen to fit our sample
geometry.
...
signal. Which input is used depends on user preference and on how the
manufacturer configures the generator, which is typically customizable. In
...
from above. The sample assembly is not attached to any of these flanges. It
...
The point is that a fairly linear operational calibration exists for a
given setup, not that there is a universal command--temperature law. A
...
Grant No.~1610077.
\todo{add the SEM facility's standard acknowledgment text.}
% NSF grant sentence supplied by S. Baird (PR #12, 2026-07-22).
% TODO: insert the BYU electron-microscopy (SEM) facility's standard
% acknowledgment text (S. Baird, PR #12, 2026-07-22).
\end{acknowledgments}
