...
cost.
\todo{add the NSF grant number (likely DMR); O. Johnson will share it.}
\todo{add the SEM facility's standard acknowledgment text.}
% TODO (O. Johnson): NSF grant number (likely DMR) -- add as "This work was
% supported by the National Science Foundation under Grant No. DMR-XXXXXXX."
% (S. Baird, PR #12, 2026-07-22).
