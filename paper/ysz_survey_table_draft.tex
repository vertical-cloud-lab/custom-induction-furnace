...
%% blank.
%%
%% DECISION (R. Guymon, PR #12, 2026-08-11): the authors decided NOT to
%% insert this table into the SI. Kept in the repo as a lab-record
%% transcription only; do not insert without a new author request.
%%
%% Intended destination (if that decision is ever revisited): SI Sec. SIV
%% (high-temperature extension), as
